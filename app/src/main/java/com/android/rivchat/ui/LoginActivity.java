...
//                            FirebaseDatabase.getInstance().getReference().child("user").child("avata").setValue("default");
//                            FirebaseDatabase.getInstance().getReference().child("user").child("email").setValue(user.getEmail());
...
//            Toast.makeText(getApplicationContext(),"Google Sign is " + result.isSuccess(), Toast.LENGTH_SHORT).show();
//            if (result.isSuccess()) {
